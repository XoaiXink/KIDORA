...
namespace KIDORA.Areas.Admin.Controllers
{
    ...
    public class NhaCungCapsController : Controller
    {
        ...
        public NhaCungCapsController(KidoraDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaNcc,TenNcc,TenLienHe,DienThoai,Email,DiaChi,ThanhPho,QuocGia,HinhThucThanhToan,ConHopTac")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaNcc,TenNcc,TenLienHe,DienThoai,Email,DiaChi,ThanhPho,QuocGia,HinhThucThanhToan,ConHopTac")] NhaCungCap nhaCungCap)
        {
